...
if __name__ == '__main__':
    try:
        ...
        browser_url_list = []
        urlpost = feedparser.parse('https://www.blogger.com/feeds/2795701393873095505/posts/default?max-results=100')
        for x in urlpost.entries:
            browser_url_list.append(str(x.link))
        number_total = 0
        number_success = 0
        number_fail = 0
        if browser_url_list:
